...
class CreateUser extends Command
{
    ...
    // В метод будет передан объект типа InputInterface,содержащий значения аргументов;
    // и объект типа OutputInterface,имеющий методы для форматирования и вывода сообщений
